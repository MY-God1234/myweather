/*
* @Author: 贾姗姗
* @Date:   2018-01-19 15:53:49
* @Last Modified by:   贾姗姗
* @Last Modified time: 2018-01-20 16:50:53
*/
// 引入远程数据
// 关于城市的信息
var city;
...
function updata(){
	...
	// 今天的天气情况
		var taday_condition=document.getElementsByClassName("con")[0];
		taday_condition.innerHTML=tianqi.weather.dat_condition;
	// 当前最高温度
	...
	// 当前最高温度
		var tomorrow_high_temperature=document.getElementsByClassName("heigher1")[0];
    ...
    // 获取每小时的天气情况(var 定义变量   后面都是其变量的值)
        ...
        // 未来十五天的天气情况
			...
			// 创建box
				...
				tianqi_condition.className="weather";
